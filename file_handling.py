...
speech_reader(
    "Obama", "C:/Users/austi/Documents/GitHub/30daysofPython/files/obama_speech.txt"
)

# Read michelle_obama_speech.txt file and count number of lines and words
speech_reader(
    "Michelle",
    "C:/Users/austi/Documents/GitHub/30daysofPython/files/michelle_obama_speech.txt",
)

# Read donald_speech.txt file and count number of lines and words
speech_reader(
    "Trump", "C:/Users/austi/Documents/GitHub/30daysofPython/files/donald_speech.txt"
)

# Read melina_trump_speech.txt file and count number of lines and words
speech_reader(
    "Melina",
    "C:/Users/austi/Documents/GitHub/30daysofPython/files/melina_trump_speech.txt",
)
...
most_spoken_language_json(
    "C:/Users/austi/Documents/GitHub/30daysofPython/files/countries_data.json", 10
)
most_populated_countries_json(
    "C:/Users/austi/Documents/GitHub/30daysofPython/files/countries_data.json", 10
)
